    ...
    <section className='container-fluid intro-mapa'>
        ...
        <div className="row">
          <div className="col-md-8">
            <p className="text-right">Puede <a href="https://www.google.com/maps/d/viewer?mid=1Q1kDWfyz0PCdRx1OFlNoOA644HP9W2Bu&ll=-37.97165492717815%2C-57.78389299999999&z=10" tabIndex="50" target="_blank">ver el mapa en detalle aquí</a></p>
          </div>
