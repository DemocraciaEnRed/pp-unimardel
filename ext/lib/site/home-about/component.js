          ...
          <div className='ext-acerca-de container'>
            <div className='filas'>
              <div className='faq text-left'>
                <p className='info-reglamento'>Accedé al <a target="_blank" href="https://democraciaenred.nyc3.digitaloceanspaces.com/projects/pp-unimardel/2025-unmdp-reglamento.pdf">reglamento general</a> del Presupuesto Participativo de la Universidad Nacional de Mar del Plata. En este espacio, te compartimos algunas normas básicas para que conozcas el funcionamiento de la iniciativa.</p>
                {faqs && 
