        ...
        <Anchor id='container'>
          <div className='ext-terminos-y-condiciones'>
            ...
            <p>
              ...
              La plataforma ParticipaMGP PP es un sitio web que promueve el compromiso de los ciudadanos con la comunidad en la que habitan y con su entorno, propicia la participación ciudadana en la gestión y el control del gobierno municipal y consolida un espacio institucional de participación ciudadana en el municipio destinado a decidir el destino de una partida presupuestaria específica del presupuesto municipal.
            </p>

            <h2><span>Registro en la plataforma web</span></h2>
            <p>
              El ingreso a ParticipaMGP no requiere registro online previo, el mismo será requerido si la/el usuaria/o desea publicar contenidos o interactuar con otros/as usuarios/as. <br />
              Esperamos que te registres usando tu nombre. Las cuentas de "bots" u otros registros automáticos no están permitidas. Los/as usuarios/as son responsables de preservar la privacidad de su cuenta protegiendo el acceso a sus contraseñas. Por favor, ante cualquier ingreso indebido en tu cuenta, comunicate inmediatamente a través de <a href="mailto:ParticipaMGP@mardelplata.gob.ar">ParticipaMGP@mardelplata.gob.ar</a>
            </p>
            ...
            <ul>
                ...
                <li>Los/as usuarios/as se comprometen a notificar a ParticipaMGP del uso no autorizado de su clave.</li>
                <li>ParticipaMGP se reserva el derecho de rechazar cualquier solicitud de inscripción o de cancelar un registro previamente aceptado.</li>
            </ul>
            ...
            <ul>
              ...
              <li>Promover, defender o mostrar pornografía, obscenidad, vulgaridad, blasfemia, odio, fanatismo, racismo y/o violencia. En caso de sufrir alguna de estas situaciones, comunicarse con el Administrador a través de ParticipaMGP.</li>
