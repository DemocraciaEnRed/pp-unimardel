        ...
        <Anchor id='container'>
          <div className='ext-terminos-y-condiciones'>
            ...
            <p>
              ...
              La plataforma ParticipaUNMDP PP es un sitio web que promueve el compromiso de los ciudadanos con la comunidad en la que habitan y con su entorno, propicia la participación ciudadana en la gestión y el control del gobierno municipal y consolida un espacio institucional de participación ciudadana en el municipio destinado a decidir el destino de una partida presupuestaria específica del presupuesto municipal.
            </p>

            <h2><span>Registro en la plataforma web</span></h2>
            <p>
              El ingreso a ParticipaUNMDP no requiere registro online previo, el mismo será requerido si la/el usuaria/o desea publicar contenidos o interactuar con otros/as usuarios/as. <br />
              Esperamos que te registres usando tu nombre. Las cuentas de "bots" u otros registros automáticos no están permitidas. Los/as usuarios/as son responsables de preservar la privacidad de su cuenta protegiendo el acceso a sus contraseñas. Por favor, ante cualquier ingreso indebido en tu cuenta, comunicate inmediatamente a través de <a href="mailto:ParticipaUNMDP@mardelplata.gob.ar">ParticipaUNMDP@mardelplata.gob.ar</a>
            </p>

            <h2><span>Validación de usuarios</span></h2>
            <p>Universidad de Mar del Plata se reserva el derecho de validar la información brindada por la/el usuaria/o al momento de la inscripción. En caso de que la información brindada no pueda validarse, Presupuesto Participativo se reserva el derecho de no dar de alta a ese usuario/a. Por su parte, Presupuesto Participativo deslinda su responsabilidad en el caso de no ser veraz la información suministrada al respecto.<br/>
            ...
            <ul>
                ...
                <li>Los/as usuarios/as se comprometen a notificar a ParticipaUNMDP del uso no autorizado de su clave.</li>
                <li>ParticipaUNMDP se reserva el derecho de rechazar cualquier solicitud de inscripción o de cancelar un registro previamente aceptado.</li>
            </ul>
            ...
            <p>
              ...
              La/El usuaria/o es responsable del contenido que suba, publique o muestre en ParticipaUNMDP, garantizando que el mismo no infringe derechos de terceras personas ni los Términos y Condiciones de Uso ni viola ninguna ley, reglamento u otra normativa. Los/as usuarios/as entienden y aceptan que el material y/o contenido que suba y/o publique podría ser utilizado por otros/as usuarios/as de la plataforma web y/o por terceras personas ajenas, y que ParticipaUNMDP no será responsable en ningún caso por tales utilizaciones.<br/>
              La/El usuaria/o debe usar ParticipaUNMDP en forma correcta y lícita. En caso contrario, ParticipaUNMDP podrá retirar el contenido y/o suspender la cuenta de aquellos/as usuarios/as que incurran en actitudes contrarias a estos términos y condiciones y/o de la política de privacidad, ofensivas, ilegales, violatorias de derechos de terceras personas, contrarias a la moral y buenas costumbres y/o amenaza para la seguridad de otros usuarios.<br/>
              En relación a los aportes, colaboraciones y comentarios que los/as usuarios/as realicen con respecto a las iniciativas propuestas, las mismas no son de carácter vinculante, obligatorio y/o impositivo sobre las acciones de Universidad de Mar del Plata.
            </p>
            ...
            <ul>
              ...
              <li>Promover, defender o mostrar pornografía, obscenidad, vulgaridad, blasfemia, odio, fanatismo, racismo y/o violencia. En caso de sufrir alguna de estas situaciones, comunicarse con el Administrador a través de ParticipaUNMDP.</li>
              <li>Vulnerar los derechos establecidos en la Ley N° 25.326 de Protección de Datos Personales. ​</li>
            </ul>
            <p>En caso de sufrir alguna de estas situaciones, comunicarse con Presupuesto Participativo a través de  <a href="mailto:ParticipaUNMDP@mardelplata.gob.ar">ParticipaUNMDP@mardelplata.gob.ar</a>.</p>

            <h2><span>Moderación de la actividad en Presupuesto Participativo</span></h2>
            <p>La actividad en esta plataforma web contará con moderadores/as responsables de hacer cumplir estos Términos y Condiciones de Uso. Los/as mismos/as serán designados/as por Universidad de Mar del Plata en pos de fomentar un diálogo franco y abierto que evite afrentas a personas o instituciones, material comercial no relacionado (SPAM) u otros desvíos de la intención original de Presupuesto Participativo.</p>
            <ul>
            ...
            <p>
              Las interacciones en UNMDP Presupuesto Participativo requiere que los/as usuarios/as se registren. En ese caso, se solicitará información personal, como nombre y apellido, documento, dirección legal y dirección de correo electrónico. El perfil que es visible públicamente puede incluir el nombre y la foto seleccionada.<br/>
              Asimismo, si un/a usuario/a se pone en contacto con UNMDP Presupuesto Participativo, es posible que guardemos constancia de la comunicación para poder resolver más fácilmente cualquier incidencia que se haya producido.<br/>
            ...
            <p>
                UNMDP Presupuesto Participativo puede recopilar información sobre la forma en que los/as usuarios/as usan la plataforma. Entre la información obtenida de esta forma, se incluye el tipo de navegador utilizado, la preferencias de lenguaje y, por ejemplo, los comentarios que ha realizado.<br/>
                UNMDP Presupuesto Participativo podrá compartir información de manera agregada, y en carácter no personal, con el público en general (por ejemplo, mostrar tendencias sobre el uso del sitio).<br/>
                UNMDP Presupuesto Participativo garantiza la debida protección de los datos personales almacenados en esta plataforma web así como también el acceso a la información registrada en el mismo, de conformidad a lo establecido en el artículo 43, párrafo tercero de la Constitución Nacional y la Ley N° 25.326 de Protección de los Datos Personales.<br/>
            </p>

            <h2><span>Tecnología:</span></h2>
            <p>
                Presupuesto Participativo es un desarrollo basado en <a href="https://democracyos.org/" target="_blank">DemocracyOS</a> con la coordinación de la Universidad de Mar del Plata. DemocracyOS es una plataforma online de código abierto especialmente diseñada para informar, debatir y comprometerse con propuestas públicas hacia la construcción de una democracia adaptada al siglo XXI. DemocracyOS es desarrollado por la Fundación <a href="https://democraciaenred.org/" target="_blank">Democracia en Red</a>.
            </p>
