      ...
      <div>
        ...
        <Anchor id='container'>
          <div className='ext-terminos-y-condiciones'>
            ...
            <p>Los siguientes Términos y Condiciones regulan el uso de la Plataforma MGP Presupuesto Participativo.<br/>
            ...
            <ul>
                ...
                <li>Los/as usuarios/as se comprometen a notificar a MGP Presupuesto Participativo del uso no autorizado de su clave.</li>
                <li>MGP Presupuesto Participativo se reserva el derecho de rechazar cualquier solicitud de inscripción o de cancelar un registro previamente aceptado.</li>
            </ul>
            ...
            <p>
              ...
              La/El usuaria/o es responsable del contenido que suba, publique o muestre en MGP Presupuesto Participativo, garantizando que el mismo no infringe derechos de terceras personas ni los Términos y Condiciones de Uso ni viola ninguna ley, reglamento u otra normativa. <br/>Los/as usuarios/as entienden y aceptan que el material y/o contenido que suba y/o publique podría ser utilizado por otros/as usuarios/as de la plataforma web y/o por terceras personas ajenas, y que MGP Presupuesto Participativo no será responsable en ningún caso por tales utilizaciones.<br/>
              La/El usuaria/o debe usar MGP Presupuesto Participativo en forma correcta y lícita. En caso contrario, MGP Presupuesto Participativo podrá retirar el contenido y/o suspender la cuenta de aquellos/as usuarios/as que incurran en actitudes contrarias a estos términos y condiciones y/o de la política de privacidad, ofensivas, ilegales, violatorias de derechos de terceras personas, contrarias a la moral y buenas costumbres y/o amenaza para la seguridad de otros usuarios.<br/>
              En relación a los aportes, colaboraciones y comentarios que los/as usuarios/as realicen con respecto a las iniciativas propuestas, las mismas no son de carácter vinculante, obligatorio y/o impositivo sobre las acciones de la Ciudad Nacional de Rosario.
            </p>
            ...
            <ul>
              ...
              <li>Promover, defender o mostrar pornografía, obscenidad, vulgaridad, blasfemia, odio, fanatismo, racismo y/o violencia. En caso de sufrir alguna de estas situaciones, comunicarse con el Administrador a través de MGP Presupuesto Participativo</li>
            ...
            <p>La actividad en esta plataforma web contará con moderadores/as responsables de hacer cumplir estos Términos y Condiciones de Uso. Los/as mismos/as serán designados/as por la  Ciudad Nacional de Rosario en pos de fomentar un diálogo franco y abierto que evite afrentas a personas o instituciones, material comercial no relacionado (SPAM) u otros desvíos de la intención original de Presupuesto Participativo.</p>
            <ul>
            ...
            <p>
              Las interacciones en MGP Presupuesto Participativo requiere que los/as usuarios/as se registren. En ese caso, se solicitará información personal, como nombre y apellido, documento, dirección legal y dirección de correo electrónico. El perfil que es visible públicamente puede incluir el nombre y la foto seleccionada.<br/>
              Asimismo, si un/a usuario/a se pone en contacto con MGP Presupuesto Participativo, es posible que guardemos constancia de la comunicación para poder resolver más fácilmente cualquier incidencia que se haya producido.<br/>
            ...
            <p>
                MGP Presupuesto Participativo puede recopilar información sobre la forma en que los/as usuarios/as usan la plataforma. Entre la información obtenida de esta forma, se incluye el tipo de navegador utilizado, la preferencias de lenguaje y, por ejemplo, los comentarios que ha realizado.<br/>
                MGP Presupuesto Participativo podrá compartir información de manera agregada, y en carácter no personal, con el público en general (por ejemplo, mostrar tendencias sobre el uso del sitio).<br/>
