    ...
    <div className='container'>
      ...
      <div className='terminos'>
        <Link to='/s/terminos-y-condiciones' tabIndex="108"> Términos y condiciones
            ...
            <a href="https://democraciaenred.nyc3.digitaloceanspaces.com/projects/pp-unimardel/2025-unmdp-reglamento.pdf" tabIndex="109" rel="noopener noreferer" target="_blank"> Reglamento
        </a>
      </div>
    </div>
  </footer>
