      ...
      <div className='form-propuesta'>
        ...
        <form className='wrapper' onSubmit={this.handleSubmit}>
          ...
          )}
          {
            ...
            <p className="more-info add-color">*La propuesta será revisada por el equipo de la Universidad Nacional de Mar del Plata y notificará su factibilidad a la brevedad. Si la propuesta es factible, pasará a la etapa de votación</p>
