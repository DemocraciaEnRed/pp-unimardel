      ...
      <div className="container-fluid">
        ...
        {/* <div className="row cont">
            <div className="intro-ideas">
              ...
              Con <strong>Participa UNMDP</strong> vas a poder presentar los proyecto
              </h2>
            </div>
        </div>     */}
        ...
        <div className="row cont">
          ...
          <div className="col-md-4">
            ...
            <h2 className="text-center UNMDP">{props.texts['home-icono2-titulo']}</h2>
          ...
          <div className="col-md-4">
            ...
            <h2 className="text-center UNMDP">
