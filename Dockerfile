...
ENV LOCALE=es \
  ...
  NOTIFICATIONS_MAILER_NAME='Presupuesto Participativo de la Universidad de Mar del Plata' \
  ORGANIZATION_EMAIL=presupuestoparticipativo@mdp.edu.ar \
  ORGANIZATION_NAME='Presupuesto Participativo' \
  SOCIALSHARE_SITE_NAME='Presupuesto Participativo de la Universidad de Mar del Plata' \
  SOCIALSHARE_SITE_DESCRIPTION='Plataforma de participación ciudadana de de la Universidad de Mar del Plata.' \
