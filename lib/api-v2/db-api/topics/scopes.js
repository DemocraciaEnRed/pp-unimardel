...
const facultadScopes = require('../facultades/scopes')
const claustroScopes = require('../claustros/scopes')
...
exports.ordinary.populate = [
  ...
  {
    path: 'facultad',
    select: facultadScopes.ordinary.select
  },
  {
    path: 'claustro',
    select: claustroScopes.ordinary.select
  },
  {
    path: 'tag',
