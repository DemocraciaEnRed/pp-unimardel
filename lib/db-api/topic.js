...
exports.searchTopicsByOwner = function searchTopicsByOwner (owner, fn) {
  var query = { owner: owner, deletedAt: null }

  log('Searching for topics by owner %s', owner)
  Topic
    .find(query)
    .populate('tag')
    .populate('facultad')
...
exports.getAll = () => {
  return Topic.find({ deletedAt: null })
}
