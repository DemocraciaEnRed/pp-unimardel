...
export default class SignUp extends Component {
  ...
  componentWillMount () {
    ...
    zonaStore.findAll().then(zonas => this.setState({zonas}))
  }
          ...
          (
            <div id='signup-form'>
              ...
              <FormAsync
                ...
                <div className='form-group'>
                  <label htmlFor=''>Zona <button type="button" onClick={() => this.setShowMap()} className="btn btn-link">¿Cómo sé en que zona vivo?</button></label>
                  <select
                    className='form-control'
                    id='zona'
                    name='zona'
                ...
                {this.state.showMap && <div>
                  <iframe src="https://www.google.com/maps/d/embed?mid=1lCtk77BcCijc9i12q4Kg6RQTsejF1aJJ" width="640" height="480"></iframe>
                  <p>Puede ver el <a href="https://www.google.com/maps/d/u/0/viewer?mid=1lCtk77BcCijc9i12q4Kg6RQTsejF1aJJ&ll=-37.97165492717816%2C-57.78389299999999&z=10" target="_blank">mymaps completo aqui</a></p>
                  </div>}
                <div className='form-group'>
