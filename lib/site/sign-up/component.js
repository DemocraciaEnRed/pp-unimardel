...
export default class SignUp extends Component {
  constructor (props) {
    ...
    this.saveBarrioAndSetFacultad = this.saveBarrioAndSetFacultad.bind(this)
  ...
  saveBarrioAndSetFacultad (e) {
    this.setState({ barrio: e.target.value })
    const {facultades} = this.state
    const finalFacultad = facultades.find(facultad => facultad.barrios.includes(e.target.value))
    if (finalFacultad) {
  ...
  render () {
    const { facultades, barrios } = this.state
              ...
              <FormAsync
                ...
                <div className='form-group'>
                  ...
                  <select
                    ...
                    id='barrio'
                    name='barrio'
                    onChange={this.saveBarrioAndSetFacultad}
                    required
                    >
